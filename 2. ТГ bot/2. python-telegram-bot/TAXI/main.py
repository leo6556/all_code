...
def pay_p(update:Update, context:CallbackContext):
    ...
    markup = InlineKeyboardMarkup(
        inline_keyboard= [
            [
                InlineKeyboardButton(f'наличными {pay}р.', callback_data="pppp"),
                # InlineKeyboardButton('Оплата онлайн\n(59р.)', callback_data='pppo')
                InlineKeyboardButton(f'по карте {int(pay) + 9}р.', callback_data="pppp"),
            ],
            [
...
def main():
    ...
    # 1940112781: AAFapfgmszNYUYFGLOITgshBLgAF5hSG1SA
